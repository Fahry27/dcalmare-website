    ...
    >
      <div className="container-pad grid min-h-[calc(100svh-4rem)] items-center gap-8 py-12 md:min-h-[calc(100svh-5rem)] md:grid-cols-[1.15fr_0.85fr] md:gap-10 md:py-20">
        <ScrollReveal className="min-w-0">
          ...
          <Link
            href="/shop"
            className="mt-8 inline-flex min-h-12 w-full items-center justify-center bg-offwhite px-5 text-center text-sm font-semibold uppercase tracking-[0.1em] text-burgundy transition hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-burgundy sm:w-auto sm:px-7 sm:tracking-[0.18em]"
          >
            Shop The First Drop
          </Link>
        </ScrollReveal>
